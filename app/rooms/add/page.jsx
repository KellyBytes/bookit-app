...
const AddRoomPage = () => {
  const [state, runAction] = useActionState(createRoom, {});
        ...
        <form action={runAction}>
          ...
          <div className="mb-8">
            <label
              htmlFor="image"
              // className="block text-gray-700 font-bold mb-2"
              className="inline-block cursor-pointer bg-gray-200 text-gray-700 font-bold px-4 py-2 rounded border border-gray-700 hover:bg-gray-300"
            >
              Choose Image File
            </label>
